package barreras.mario.myfeelings

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import android.widget.Toast
import barreras.mario.myfeelings.utilities.CustomBarDrawable
import barreras.mario.myfeelings.utilities.CustomCircleDrawable
import barreras.mario.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun guardar(){
            ...
            Toast.makeText(this, "Datos Ganadores Guardados", Toast.LENGTH_SHORT).show()
        }
        jsonFile=JSONFile()
